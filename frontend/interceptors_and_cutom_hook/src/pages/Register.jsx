...
const Register = () => {
  let { register, RegisterformSubmit, handleSubmit, reset, errors } =
    AuthHook();
  return (
    <div className="bg-neutral-900/90 border border-neutral-800 rounded-2xl p-6 sm:p-8 shadow-2xl backdrop-blur-sm">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-sm text-neutral-400 mt-1">
          Join us today to get started with your account
        </p>
      </div>

      {/* Form (UI only - add your functionality here) */}
      <form className="space-y-4" onSubmit={handleSubmit(RegisterformSubmit)}>
        {/* Name Field */}
        <div>
        ...
        <button
          type="submit"
          className="w-full mt-2 py-2.5 px-4 bg-indigo-600 hover:bg-indigo-500 text-white font-medium rounded-xl text-sm transition-all duration-200 shadow-lg shadow-indigo-600/25 active:scale-[0.99] cursor-pointer"
        >
          Create Account
        </button>
      </form>
