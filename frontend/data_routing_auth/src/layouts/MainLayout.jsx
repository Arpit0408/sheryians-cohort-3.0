...
const MainLayout = () => {
  ...
  const navItems = [
    { name: "Dashboard", path: "/main", icon: <FiHome className="text-lg" /> },
    { name: "Feed / Posts", path: "/main/posts", icon: <FiGrid className="text-lg" /> },
    { name: "Profile", path: "/main/profile", icon: <FiUser className="text-lg" /> },
    { name: "Settings", path: "/main/settings", icon: <FiSettings className="text-lg" /> },
  ];
